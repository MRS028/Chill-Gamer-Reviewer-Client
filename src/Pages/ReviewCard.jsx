...
const ReviewCard = ({ review }) => {
  ...
  return (
    <div className="group relative bg-base-200 shadow-lg rounded-xl overflow-hidden hover:shadow-xl transition-shadow duration-300">
      <img
        src={gameCover}
        alt={gameTitle}
      ...
      <div className="p-5">
        ...
        <Link to={`/review/${_id}`}>
          <button className="mt-4 w-full py-2 text-sm font-semibold rounded-lg bg-[#30beba] text-white hover:bg-green-500 transition-colors">
            Explore Details
          </button>
        </Link>
      </div>
